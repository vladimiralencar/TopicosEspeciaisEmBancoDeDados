...
with st.container():
    ...
    # Cria o canvas
    canvas_result = st_canvas(stroke_width = 60, #10,
                              stroke_color = "#000000",
                              background_color = "#FFFFFF",
                              update_streamlit = True,
                              height = 280*2, #280, #300,
                              width = 280*2, #280, #300,
    ...
    if predict_button:
        ...
        result = (canvas_result.image_data[:, :, :]).astype(np.uint8) 
        ...
        img = img / 255.0 / 2 # 0 e 0.5 - Normalização Fina
        ...
        st.write("Probabilidades das Previsões: ", probs)
